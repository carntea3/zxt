...
if [ -z "$1" ]; then
    ...
    echo -e "${blue}    │   ${yellow}Copyright${reset} (C)${gray} https://t.me/carntech   ${neutral}"
    echo -e "${blue}    └───────────────────────────────────────────────┘${neutral}"
    echo -e "${blue}    ────────────────────────────────────────────────${neutral}"
...
data=$(curl -s https://raw.githubusercontent.com/carntea3/zxt/refs/heads/main/izin)
key=$(echo "$data" | grep "$ip" | awk '{print $2}')

# URL sumber konfigurasi dan binary
nginx_key_url="https://nginx.org/keys/nginx_signing.key"
dropbear_init_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/dropbear/dropbear"
dropbear_conf_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/examples/dropbear"
dropbear_dss_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/dropbear/dropbear_dss_host_key"
sshd_conf_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/examples/sshd"
banner_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/examples/banner"
common_password_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/examples/common-password"
ws_py_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/websocket/ws.py"
gotop_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/gotop"
haproxy_cfg_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/Haproxy/haproxy.cfg"
xray_conf_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/nginx/xray.conf"
udp_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/udp/udp-custom-linux-amd64"
nginx_conf_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/nginx/nginx.conf"
badvpn_url="https://raw.githubusercontent.com/carntea3/zxt/main/BadVPN-UDPWG/badvpn"
openvpn_url="https://raw.githubusercontent.com/carntea3/zxt/main/fodder/openvpn/openvpn.zip"
vmess_url="https://raw.githubusercontent.com/carntea3/zxt/main/VMess-VLESS-Trojan+Websocket+gRPC/vmess/config.json"
vless_url="https://raw.githubusercontent.com/carntea3/zxt/main/VMess-VLESS-Trojan+Websocket+gRPC/vless/config.json"
trojan_url="https://raw.githubusercontent.com/carntea3/zxt/main/VMess-VLESS-Trojan+Websocket+gRPC/trojan/config.json"
shadowsocks_url="https://raw.githubusercontent.com/carntea3/zxt/main/VMess-VLESS-Trojan+Websocket+gRPC/shadowsocks/config.json"
...
cd /etc/menu
    ...
    url="https://github.com/carntea3/zxt/raw/refs/heads/main/project/project.zip"
...
# msbreewc
7z e -pGopayMeno menu.zip >/dev/null 2>&1
...
wget --no-check-certificate -O /opt/bbr.sh https://raw.githubusercontent.com/carntea3/zxt/main/fodder/bbr.sh
...
documentation="Documentation=https://t.me/gerhanatunnel"
...
wget -q -O /root/.bot/bot.zip https://raw.githubusercontent.com/carntea3/zxt/raw/main/bot.zip
